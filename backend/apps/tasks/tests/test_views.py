...
class TaskViewSetTests(APITestCase):
    ...
    def test_list_tasks_unauthenticated(self):
        ...
        response: Response = self.client.get("/api/tasks/")
    ...
    def test_retrieve_task(self):
        ...
        self.client.force_authenticate(user=self.user)
        response: Response = self.client.get(f"/api/tasks/{self.task.id}/")
    ...
    def test_retrieve_other_user_task_forbidden(self):
        ...
        self.client.force_authenticate(user=self.user)
        response: Response = self.client.get(f"/api/tasks/{self.other_task.id}/")
    ...
    def test_update_task(self):
        ...
        response: Response = self.client.patch(f"/api/tasks/{self.task.id}/", data, format="json")
    ...
    def test_update_other_user_task_forbidden(self):
        ...
        response: Response = self.client.patch(f"/api/tasks/{self.other_task.id}/", data, format="json")
    ...
    def test_delete_task(self):
        ...
        response: Response = self.client.delete(f"/api/tasks/{task_id}/")
    ...
    def test_delete_other_user_task_forbidden(self):
        ...
        self.client.force_authenticate(user=self.user)
        response: Response = self.client.delete(f"/api/tasks/{self.other_task.id}/")
    ...
    def test_user_cannot_reassign_task(self):
        ...
        # Patch result is not inspected directly; cast to Response for typing
        _ = cast(Response, self.client.patch(f"/api/tasks/{self.task.id}/", data, format="json"))
...
class TaskGroupViewSetTests(APITestCase):
    ...
    def test_list_groups_unauthenticated(self):
        ...
        response: Response = self.client.get("/api/groups/")
    ...
    def test_create_group_authenticated(self):
        ...
        response: Response = self.client.post("/api/groups/", data, format="json")
    ...
    def test_update_group(self):
        ...
        response: Response = self.client.patch(f"/api/groups/{self.group.id}/", data, format="json")
    ...
    def test_update_other_user_group_forbidden(self):
        ...
        response: Response = self.client.patch(f"/api/groups/{self.other_group.id}/", data, format="json")
    ...
    def test_delete_group(self):
        ...
        response: Response = self.client.delete(f"/api/groups/{group_id}/")
    ...
    def test_delete_other_user_group_forbidden(self):
        ...
        self.client.force_authenticate(user=self.user)
        response: Response = self.client.delete(f"/api/groups/{self.other_group.id}/")
    ...
    def test_reorder_groups(self):
        ...
        response: Response = self.client.patch("/api/groups/reorder/", data, format="json")
