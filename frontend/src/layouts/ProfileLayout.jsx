import { UserCircle2, Mail, CheckCircle, Circle, Clock, ListChecks, ArrowLeft } from "lucide-react"
...
function ProfileLayout() {
    ...
    if (loading && tasks.length === 0) {
        return (
            <div className="w-full min-h-screen bg-linear-to-br from-violet-100 to-purple-100 flex items-center justify-center">
                <Spinner />
            </div>
        )
    }
    ...
    return (
        <div className="w-full min-h-screen bg-linear-to-br from-violet-100 to-purple-100 py-12 px-4">
